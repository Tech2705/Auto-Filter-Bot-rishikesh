...
# Bot information
API_ID = environ.get('API_ID', '24792111')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '847de3c849cc0c68240aa5154a437bfe'') #api hash of your telegram id
if len(API_HASH) == 0:
...
# Bot pics
PICS = (environ.get('PICS', 'https://graph.org/file/e4b2b1c88153071e54841.jpg')).split()

# Bot Admins
ADMINS = environ.get('ADMINS', '1876329759') #apni tg id daalo
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002166283591').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002070438514').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002197099470') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002228923018') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Bisal:Bisal123@bisal.qt3ma.mongodb.net/?retryWrites=true&w=majority&appName=Bisal") #mongo db url
...
UPI_ID = environ.get('UPI_ID', 'rishabhbahuguna76@oksbi') # Add your upi id here
# for stream
IS_STREAM = is_enabled('IS_STREAM', True) #true if you want stream feature active in your bot
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002197099470") #if is_stream = true then add a channel id ex: -10026393639
